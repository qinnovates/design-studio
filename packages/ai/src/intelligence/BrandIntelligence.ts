...
export const BRAND_PERSONAS: BrandPersona[] = [
  {
    ...
    evaluationFocus: 'Will this name/tagline convert? Is it shareable? Does it work in ads? Named after Edward Bernays (1891-1995), the father of public relations who pioneered modern marketing psychology.',
    avatar: 'B',
  },
  {
    id: 'linguist',
    ...
    evaluationFocus: 'How does it sound? Is it pronounceable globally? Any negative connotations in other languages? Named after Ferdinand de Saussure (1857-1913), founder of modern linguistics and semiotics.',
    avatar: 'S',
  },
  {
    id: 'seo-expert',
    name: 'Lovelace',
    role: 'Search & Discovery Strategist',
    evaluationFocus: 'Is it searchable? Will it rank? Is the domain landscape favorable? Named after Ada Lovelace (1815-1852), the first computer programmer who saw machines as tools for any symbolic system.',
    avatar: 'A',
  },
  {
    id: 'brand-strategist',
    ...
    evaluationFocus: 'Does it align with the brand positioning? Is it scalable as the company grows? Named after the Medici family (1360-1743), Renaissance patrons who understood that identity and patronage build lasting empires.',
    avatar: 'M',
  },
  {
    id: 'user-advocate',
    ...
    evaluationFocus: 'Would target users understand this immediately? Does it resonate with their pain points? Named after Socrates (470-399 BC), who taught through questions — understanding the audience before prescribing answers.',
    avatar: 'Q',
  },
];
